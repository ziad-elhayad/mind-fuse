...
export default function Services() {
  return (
    <div className="relative overflow-hidden">
      ...
      {/* ── HERO ──────────────────────────────────────────── */}
      <section className="relative pt-32 pb-16 min-h-[55vh] flex items-center">
            ...
            return (
              <FadeIn key={service.id} delay={idx * 0.08} direction="up">
                <HoverCard scale={1.01} lift={-6}>
                  <div className="group relative rounded-3xl border border-[#06599B]/15 bg-white/90 backdrop-blur-md overflow-hidden hover:border-[#06599B]/30 transition-all duration-500 p-8 md:p-12 flex flex-col lg:flex-row justify-between gap-12 shimmer-card">
                    {/* Accent bar */}
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-2">
                        {service.features.map((feature, fi) => (
                          <motion.div
                            ...
                            viewport={{ once: true }}
                            transition={{ delay: fi * 0.06 + idx * 0.04 }}
                          >
                    ...
                    <div className="lg:w-[340px] shrink-0 border-t lg:border-t-0 lg:border-l border-[#06599B]/10 pt-8 lg:pt-0 lg:pl-12 flex flex-col justify-between gap-8">
      ...
      <section className="relative z-10 pb-24">
        <div className="max-w-4xl mx-auto px-6 md:px-12">
          <FadeIn direction="up">
            <div className="p-10 md:p-14 rounded-3xl border border-[#06599B]/15 bg-gradient-to-br from-[#06599B] to-[#044A80] backdrop-blur-md text-center flex flex-col gap-6 items-center animate-border-glow relative overflow-hidden">
